{
   "configurationSettings":[
	  ...
	  {
         "category":"<b>Logo Widgets</b>",
         "fields":[
            {
               "type":"paragraph",
               "value":"Add displayLogo to the application."
            },
            {
               "type":"boolean",
      ...
      },
	  {
         ...
         "fields":[
            ...
            {
               "type":"boolean",
               "fieldName":"displayLayerListTool",
               "label":"Layer List Tool"
            },
            {
               "type":"boolean",
               "fieldName":"displayBasemapTool",
               "label":"Basemap Tool"
            },
            {
               "type":"boolean",
               "fieldName":"displayBookmarkTool",
               "label":"Bookmark Tool"
            },
			{
               "type":"boolean",
               "fieldName":"displayPrintTool",
               "label":"Print Tool"
            },
			{
               "type":"boolean",
               "fieldName":"displayDrawTool",
               "label":"Draw Tool"
            }
         ]
      }
   ...
   "values":{
		...
		"displayLayerListTool":true,
		"displayBasemapTool":true,
		"displayBookmarkTool":true,
		"displayPrintTool":true,
		"displayDrawTool":true
   }
}
